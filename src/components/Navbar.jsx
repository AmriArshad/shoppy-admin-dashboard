...
const NavButton = ({ title, customFunc, icon, color, dotColor }) => (
  <TooltipComponent content={title} position="BottomCenter">
    <button type="button" onClick={() => customFunc()} stlye={{ color }} className="relative text-xl rounded-full p-3 hover:bg-light-gray">
  ...
  return (
    <div className="flex justify-between p-2 md:ml-6 md:mr-6 relative">
      ...
      <div className="flex">
        ...
        <NavButton title="Notifications" customFunc={() => handleClick('notifications')} dotColor="#03C9D7" color="blue" icon={<RiNotification3Line />} />
